...
from .pinet2_p5_prod import PreprocessLayer, PIXLayer, AddLayer, ScaleLayer, OutLayer, DotLayer, TensorProductLayer
...
class GCBlock(tf.keras.layers.Layer):
    ...
    def call(self, tensors):
        ...
        p1t1 = self.product_layer([p3, p5]) + self.dot_layer(tf.reshape(p5, (-1, 9, p5.shape[-1]))) + self.dot_layer(p3) + p1
