...
from pinn.networks.pinet2_p5_dot import PIXLayer, ScaleLayer, OutLayer, DotLayer
...
class GCBlock(tf.keras.layers.Layer):
    ...
    def call(self, tensors):
        ...
        p1t1 = tf.concat([self.product_layer([p3, tf.reshape(p9, (tf.shape(p5)[0], 3, 3, p5.shape[-1]))]), p1], axis=1)
