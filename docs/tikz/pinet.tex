...
\begin{tikzpicture}[
  ...
  \node[var]      at (0,0.5)  (v0) {$\mathbb{P}^{t}_{ik}$};
  \node[var,hide] at (2,2.5)  (v1) {$\mathbb{I}_{ijk}$};
  \node[var]      at (4,2.5)  (v2) {$\mathbb{I}^{t}_{ijk}$};
  \node[var,hide] at (6,1.5)  (v3) {$\mathbb{P}_{ik}$};
  \node[var,hide] at (8,0.5)  (v4) {$\mathbb{P}_{ik}$};
  \node[var]      at (10,0.5) (v5) {$\mathbb{P}^{t+1}_{ik}$};
  \node[var]      at (13,1.5) (v6) {$\mathbb{P}^{\mathrm{out}}_{ik}$};
  \node[var]      at (-3,1.5) (v7) {$r_{ix}$};
  \node[var]      at (-3,0.5) (v8) {$\mathbb{Z}_{i}$};
